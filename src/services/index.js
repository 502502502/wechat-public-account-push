 ...
 */
 export const getBirthdayMessage = () => {
    ...
    // 获取girl距离下次生日的时间
    const nextBir = (dayjs(dayjs().add(1,'day').format('YYYY') + '-' + birthdaygirl.date).diff(dayjs(), 'day') + 365)%365
    ...
    if (nextBir === 0) {
     ...
     // 获取boy距离下次生日的时间
     const nextBirboy = (dayjs(dayjs().add(1,'day').format('YYYY') + '-' + birthdayboy.date).diff(dayjs(), 'day') + 365)%365
     if(nextBirboy < 0){
         nextBirboy += 365
     }   
 ...
 */
 export const getKaoyanMessage = () => {
    ...
    // 获取距离考研的时间
    const nextBir = dayjs(dayjs().add(1,'day').format('YYYY') + '-' + kaoyanDate.date).diff(dayjs(), 'day')+1
 ...
 */
 export const getSijiMessage = () => {
    ...
    // 获取距离四级的时间
    const nextBir = dayjs(dayjs().add(1,'day').format('YYYY') + '-' + sijiDate.date).diff(dayjs(), 'day')+1
 ...
 */
 export const getSeeMessage = () => {
    ...
    // 获取距离见面的时间
    const nextBir = dayjs(dayjs().add(1,'day').format('YYYY') + '-' + seeDate.date).diff(dayjs(), 'day')+1
 ...
 */
 export const getLove1Message = () => {
    ...
    // 获取恋爱纪念日的时间
    const nextBir = dayjs(dayjs().add(1,'day').format('YYYY') + '-' + loveDate.date).diff(dayjs(), 'day') +1
